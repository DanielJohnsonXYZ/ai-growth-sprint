...
export const industries: Industry[] = [
  ...
  },
  {
    ...
    workflows: [
      { name: "Contract review support", now: "Fee earners manually scan for missing clauses and unusual terms.", withAi: "AI helps create a review checklist and flag areas for human approval.", timeSaved: "Faster first-pass review support" },
  ...
  },
  {
    ...
    workflows: [
      ...
      { name: "Research and benchmarking", now: "Consultants spend half a day gathering market context.", withAi: "AI helps create a structured research brief for human approval.", timeSaved: "Half a day to about 30-60 minutes for a first pass" },
